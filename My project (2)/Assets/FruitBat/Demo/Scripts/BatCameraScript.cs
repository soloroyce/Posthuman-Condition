...
public class BatCameraScript : MonoBehaviour {
    public GameObject target;
    public GameObject batCamera;
    ...
    void Update()
    {
        ...
        batCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
